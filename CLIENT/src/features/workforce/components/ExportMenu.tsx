/**
 * Export control, shared by all four workforce reports.
 *
 * The filters currently on screen are passed straight through to the server,
 * which runs the SAME scoped list function the screen used — so the file
 * matches what the user is looking at, including every row of it rather than
 * just the page they happen to be on.
 *
...
import { downloadReport, type ExportFormat, type WorkforceReport } from "../api/workforceApi";
